...
namespace MediaWeb.Data.Migrations
{
    ...
    [Migration("20200713093021_Refactoring")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MediaWeb.Domain.Media.UserFilm", b =>
                {
            ...
            modelBuilder.Entity("MediaWeb.Domain.Media.UserMusic", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("UserMusicList");
                });

            modelBuilder.Entity("MediaWeb.Domain.Media.UserPodCast", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("UserPodCasts");
                });

            modelBuilder.Entity("MediaWeb.Domain.Media.UserSerie", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("MediaWeb.Domain.Media.UserFilm", b =>
                {
                    ...
                    b.HasOne("MediaWeb.Domain.MediaWebUser", "User")
                        .WithMany()
